  ...
  {[
    ...
    return (
      ...
      <section id="rewards" className="bg-[#dbeaff] py-[64px] px-6 md:px-[48px] relative overflow-hidden">
        ...
        {/* Анімація бульбашок (Правильний синтаксис для React) */}
        <style dangerouslySetInnerHTML={{ __html: `
          ...
          .bubble {
            background: radial-gradient(circle at 30% 30%, rgba(255, 255, 255, 0.9), rgba(255, 255, 255, 0.2) 60%, rgba(255, 255, 255, 0) 100%);
        ...
        {/* Декоративні кола з Figma (на задньому фоні) */}
        <div
          className="absolute rounded-full bg-[#c2ddfd] pointer-events-none z-0"
        ...
        {/* ГОЛОВНИЙ КОНТЕНТ (z-10 щоб бути поверх бульбашок) */}
          ...
          <div className="w-full max-w-[980px] flex flex-col gap-[80px]">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="bg-white rounded-[20px] p-6 flex flex-wrap md:flex-nowrap items-center gap-6">
                ...
                <button className="shrink-0 h-12 px-6 rounded-[12px] border-2 border-[#0666c6] text-[#0666c6] text-[14px] font-[510] leading-[21px] hover:bg-[#ebf5ff] hover:border-[#0759aa] hover:text-[#0759aa] active:bg-[#dbeaff] active:border-[#064a8d] active:text-[#064a8d] transition-colors duration-150 whitespace-nowrap bg-white">
                  Share With a Friend
                </button>
              </div>
     ...
     {/* ══════════════════════════════════════════════════════
      ...
      <section className="bg-[#dbeaff] pt-[80px] pb-[160px] px-6 md:px-[48px] relative overflow-hidden">
        ...
        {/* Декоративні кола — exact Figma positions */}
        ...
        <div className="relative z-10 w-full max-w-[900px] mx-auto px-6 md:px-[40px] flex flex-col items-center gap-[40px]">
          ...
          <div className="w-full pt-[29px] flex flex-wrap justify-center gap-4">
            ...
            <a
              ...
              className="inline-flex items-center justify-center text-[#0666c6] font-[510] text-[18px] px-[40px] h-[53px] rounded-[12px] outline outline-2 outline-[#0666c6] hover:bg-[#ebf5ff] hover:outline-[#0759aa] hover:text-[#0759aa] active:bg-[#dbeaff] active:outline-[#064a8d] active:text-[#064a8d] transition-colors duration-150"
            >
              Get Help By Phone
            </a>
          </div>
