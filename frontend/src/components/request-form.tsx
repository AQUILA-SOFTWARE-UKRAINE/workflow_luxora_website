    ...
    <>
            ...
            <div className={styles.modalBody}>
              <div className={styles.modalTop}>
                ...
                <div className={styles.modalTextBlock}>
                  <p className={styles.modalTitle}>Your Request Has Been Sent</p>
                  <p className={styles.modalSubtitle}>
                    We will call you within 10 minutes to confirm the details and discuss your booking
                  </p>
                </div>
              </div>
              <Link href="/" className={styles.modalBackBtn}>Back to Home</Link>
            </div>
          </div>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className={styles.form}>
        ...
        <fieldset className={styles.fieldset}>
          <legend className={styles.legend}>Select one or more services</legend>
        ...
        <div className={styles.fieldGroup}>
          ...
          <input id="name" name="name" type="text" required placeholder="e.g. Anna Müller" className={styles.input} />
        </div>
        ...
        <div className={styles.fieldGroup}>
          ...
          <input id="phone" name="phone" type="tel" required placeholder="+49 ___ _______" className={styles.input} />
        </div>

        {/* City */}
        <div className={styles.fieldGroup}>
          <label htmlFor="city" className={styles.label}>
            City or Town <span className={styles.required}>*</span>
          </label>
        ...
        <div className={styles.fieldGroup}>
          <label htmlFor="address" className={styles.label}>
            Street Address <span style={{ fontWeight: 400, color: "#596067" }}>(optional)</span>
          </label>
          <input id="address" name="address" type="text" placeholder="e.g. Hauptstraße 12, Berlin" className={styles.input} />
        </div>

        {/* Message */}
        <div className={styles.fieldGroup}>
          <label htmlFor="message" className={styles.label}>
            Message <span style={{ fontWeight: 400, color: "#596067" }}>(optional)</span>
          </label>
          <textarea
            id="message"
            name="message"
        ...
        <div className={styles.fieldGroup}>
          <div className={styles.uploadHeader}>
            <div className={styles.uploadLabelGroup}>
              <span className={styles.uploadLabelBold}>Add a photo</span>
              <span className={styles.uploadLabelOptional}>(optional)</span>
            </div>
        ...
        <div className={styles.actions}>
          ...
          <p className={styles.finePrint}>
            ...
            <span className={styles.finePrintText}>
