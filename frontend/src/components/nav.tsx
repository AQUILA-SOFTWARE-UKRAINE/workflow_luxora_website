      ...
      {pathname !== "/contact" && (
        <div className={styles.bottomCtaBar}>
          <div className={styles.bottomCtaInner}>
            ...
            <a href="https://wa.me/4916343250808" target="_blank" rel="noreferrer" className={styles.bottomCallBtn} aria-label="Write us on WhatsApp">
      ...
      {pathname !== "/contact" && heroPassed && (
        <div className={styles.tabletCtaBar}>
          <div className={styles.tabletCtaInner}>
            ...
            <a href="https://wa.me/4916343250808" target="_blank" rel="noreferrer" className={styles.tabletCallBtn}>
              {t("orderCall")}
